"""Full-pipeline test for the small TCGA-LIHC cohort."""
...
@pytest.mark.slow
def test_full_tcga_lihc_pipeline(tmp_path, dataset_input):
    input_dir = dataset_input(DATASET_DIR, "IMPERANDI_TCGA_LIHC_INPUT")
